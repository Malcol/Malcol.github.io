...
$(function() {
	...
	var testDataUrl = "https://analisis.datosabiertos.jcyl.es/api/records/1.0/search/?dataset=bocyl&q=&facet=fecha_publicacion&facet=seccion&facet=subseccion&facet=organismo&facet=apartado&refine.apartado=B.2.+Oposiciones+y+Concursos";
	...
	loadDataTable();				  					
  	...
  	function populateDataTable(data) {
  		...
  		var aux;
  		data.records.fields.forEach(function(item){
  			aux = item.fecha_publicacion;
  			$('#example').dataTable().fnAddData( [
  				aux[0],
  				item.organismo,
  				'<center><a href="#detallePremio" id="'+item.enlace_fichero_html+'" class="btn btn-cyl">Ver</a></center>'
  			]);
  		});
  	}
